...
export default function AboutMenu() {
    return (
        <section className="m-auto my-24 pb-16 bg-[#fbf8f1]">
        ...
        <div className="flex flex-row gap-6">
            ...
            <div className="flex flex-col flex-1 gap-2">
                <img src="images/step_1.png" alt="step 1" className="m-full h-48 rounded-xl" />
                <h4 className="font-semibold text-2xl my-3 leading-7">Step 1: You Order</h4>
                <p>Choose your meal plan according to your dietary goal & requirements</p>
            </div>

            <div className="flex flex-col flex-1 gap-2">
                <img src="images/step_2.png" alt="step 2" className="m-full h-48 rounded-xl" />
                <h4 className="font-semibold text-2xl my-3 leading-7">Step 2: We Cook</h4>
                <p>Our chefs prepare your meals using fresh ingredients</p>
            </div>

            <div className="flex flex-col flex-1 gap-2">
                <img src="images/step_3.png" alt="step 3" className="m-full h-48 rounded-xl" />
                <h4 className="font-semibold text-2xl my-3 leading-7">Step 3: We Deliver</h4>
                <p>Your meals are delivered to your doorsteps</p>
            </div>

            <div className="flex flex-col flex-1 gap-2 ">
                <img src="images/step_4.png" alt="step 4" className="m-full h-48 rounded-xl" />
                <h4 className="font-semibold text-2xl my-3 leading-7">Step 4: You Enjoy</h4>
