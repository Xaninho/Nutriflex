...
export default function Hero() {
    return (
       ...
       <div className="relative h-[700px] bg-[url('/images/banner.png')] bg-cover bg-fixed flex px-20">            

            <div className="flex flex-col justify-center content-center text-white gap-3 z-20">
                <h1 className="text-8xl font-semibold leading-15">
                    Everything <br/> is better with<br/>
                    a
                    <span className="text-primary"> Meal</span>
                </h1>
                <p className="text-2xl mt-2">Clean-eating. Time-saving. Chef-prepared deliciousness.</p>
