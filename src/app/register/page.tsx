  ...
  return (
    <section className="mt-8">
      ...
      <form className="block max-w-xs mx-auto" onSubmit={handleFormSubmit}>
        ...
        <button type="submit" disabled={creatingUser} className="w-full bg-primary h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer relative overflow-hidden transition-all duration-500 ease-in-out shadow-md hover:scale-105 hover:shadow-lg
